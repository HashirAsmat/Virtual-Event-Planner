...
//the error middleware function i-e errorHandler has 4 argument, i-e errorHandler = (error,req,res,next) , notice here the error is the argument where the errorHandler accept argument from next(error) or that has been passed to the next so in this case the request will be forwarded to the particular middleware function where the middleware function could recieve the error argument i.e only that function which can receieve data from the previous middleware that has 4 arguments,   